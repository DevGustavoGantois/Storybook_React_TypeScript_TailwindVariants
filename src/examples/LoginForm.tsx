    ...
    return (
        <Box className="px-8 py-12 border border-gray-300 rounded-xl">
            <Stack>
                ...
                <Text as="span" emphasis={"low"} size={"sm"} align={"center"} className="mb-8">Please enter your credentials to login</Text>
                ...
                <Input id="password" type="password" placeholder={"Password"} className="mb-8" />
                <Button type="submit" variant={'solid'} className="mb-10">Login</Button>
            </Stack>
        </Box>
    )
}